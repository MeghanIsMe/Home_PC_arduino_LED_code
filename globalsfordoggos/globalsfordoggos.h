/*
  ...
  CRGB datatyle relies on FastLED library
	ASCII fonts for large comments: 
		https://fsymbols.com/generators/carty/ - font not named from fsymbols.com - large header
...
// When constants are declared in a source (.cpp) file, they cannot be used as compile-time constants, so they will not work as array bounds definitions
...
//static unsigned long int deltaMillis = 0;    
...
extern unsigned long int deltaMillis;  
*/

//CRGB largeFans[NUMASPECTFANS][ASPECTFANLEDS];
/*
